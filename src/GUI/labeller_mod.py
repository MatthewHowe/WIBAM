...
from utils import draw_3D_labels
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.annotations_path = "data/wibam/annotations/hand_labels/"
    ...
    def change_cam(self):
        image = self.drawnon_images[self.imageSpinBox.value()]
    ...
    def save_labels(self):
        ...
        save_file = self.annotations_path + self.image_id + ".json"
    ...
    def init_labels(self):
        file_name = self.annotations_path + self.image_id + ".json"
    ...
    def draw_labels(self):
        ...
        self.drawnon_images = draw_3D_labels(
            self.drawnon_images,
            self.current_objects,
            self.calib
        )

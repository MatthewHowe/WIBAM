...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "task",
            default="",
            help="ctdet | ddd | multi_pose " "| tracking or combined with ,",
        )
        self.parser.add_argument(
            "--dataset",
            default="coco",
        ...
        self.parser.add_argument(
            "--test_dataset", default="", help="coco | kitti | coco_hp | pascal"
        )
        ...
        self.parser.add_argument(
            "--gs_sync", default=True, help="Whether or not to sync to google cloud"
        )
        ...
        self.parser.add_argument("--num_gpus", default=1)
        self.parser.add_argument(
            "--num_workers",
            type=int,
            default=8,
        ...
        self.parser.add_argument(
            "--vis_thresh", type=float, default=0.05, help="visualization threshold."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--lr_step", type=str, default="60", help="drop learning rate by 10."
        )
        self.parser.add_argument(
            "--save_point",
            type=str,
        ...
        self.parser.add_argument(
            "--num_epochs", type=int, default=70, help="total training epochs."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--det_only", action="store_true", help="Use detection camera loss only"
        )
        self.parser.add_argument(
            "--mv_only", action="store_true", help="Use only Multiview loss in training"
        )
        self.parser.add_argument(
            "--mixed_learning",
            action="store_true",
        ...
        self.parser.add_argument(
            "--mixed_dataset", default=None, help="What dataset to mix with"
        )
        self.parser.add_argument(
            "--mixed_batchsize",
            type=int,
        ...
        self.parser.add_argument(
            "--K", type=int, default=128, help="max number of output objects."
        )
        self.parser.add_argument(
            "--not_prefetch_test",
            action="store_true",
        ...
        self.parser.add_argument("--out_thresh", type=float, default=-1, help="")
        ...
        self.parser.add_argument(
            "--model_output_list", action="store_true", help="Used when convert to onnx"
        )
        ...
        self.parser.add_argument(
            ...
            type=float,
            default=0,
            help="when not using random crop, 0.1" "apply shift augmentation.",
        )
        self.parser.add_argument(
            "--scale",
            type=float,
            default=0,
            help="when not using random crop, 0.4" "apply scale augmentation.",
        )
        self.parser.add_argument(
            "--aug_rot",
            type=float,
        ...
        self.parser.add_argument(
            ...
            type=float,
            default=1,
            help="How much of the train set to use",
        )
        ...
        self.parser.add_argument(
            "--show_repro", type=bool, default=False, help="Show image reprojections"
        )
    ...
    def parse(self, args=""):
        ...
        opt.save_imgs = (
            [i for i in opt.save_imgs.split(",")] if opt.save_imgs != "" else []
        )

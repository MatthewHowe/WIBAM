...
class ConcatDatasets:
    def __init__(self, dataloaders):
        ...
        self.batch_size = (
            self.dataloaders[0].batch_size + self.dataloaders[1].batch_size
        )
...
def mixed_dataset(
    ...
    print(
        "Main {} dataloader:\n {}\nIterations: {}\nSamples: {}\n".format(
            task, DataLoader1.dataset, len(DataLoader1), len(DataLoader1.dataset)
        )
    )
    ...
    print(
        "Mixed {} dataloader:\n {}\nIterations: {}\nSamples: {}\n".format(
            task, DataLoader2.dataset, len(DataLoader2), len(DataLoader2.dataset)
        )
    )

...
class KITTITracking(GenericDataset):
    ...
    def __init__(self, opt, split):
        ...
        ann_path = os.path.join(
            data_dir, "annotations", "tracking_{}.json".format(ann_file_)
        )
        self.images = None
    ...
    def run_eval(self, results, save_dir):
        ...
        os.system(
            "python tools/eval_kitti_track/evaluate_tracking.py "
            + "{}/results_kitti_tracking/ {}".format(save_dir, self.opt.dataset_version)
        )
